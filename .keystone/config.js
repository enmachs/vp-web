...
var Role = (0, import_core2.list)({
  ...
  fields: {
    ...
    canManageContent: (0, import_fields2.checkbox)({ defaultValue: false }),
...
var contentUi = () => ({
  hideCreate: (args) => !permissions.canManageContent(args),
  hideDelete: (args) => !permissions.canManageContent(args)
});
...
// features/keystone/models/QuoteRequest.ts
var import_core9 = require("@keystone-6/core");
var import_access7 = require("@keystone-6/core/access");
var import_fields10 = require("@keystone-6/core/fields");

// features/keystone/lib/heard-options.ts
var HEARD_OPTIONS = [
  ...
  { value: "referral", labelEs: "Recomendaci\xF3n", labelEn: "Referral" },
...
// features/keystone/models/QuoteRequest.ts
var QuoteRequest = (0, import_core9.list)({
  access: {
    operation: {
      query: permissions.canManageContent,
      create: import_access7.denyAll,
      update: import_access7.denyAll,
      delete: import_access7.denyAll
    }
  },
  ui: {
  ...
  fields: {
    fullName: (0, import_fields10.text)({ validation: { isRequired: true } }),
    ...
    fromLocation: (0, import_fields10.text)({ validation: { isRequired: true } }),
    toLocation: (0, import_fields10.text)({ validation: { isRequired: true } }),
    ...
    serviceType: (0, import_fields10.relationship)({
      ref: "ServiceType",
      many: false,
    ...
    serviceTypeLabel: (0, import_fields10.text)(),
    phone: (0, import_fields10.text)({ validation: { isRequired: true } }),
    ...
    howHeardFromUs: (0, import_fields10.select)({
      type: "string",
    ...
    details: (0, import_fields10.text)({ ui: { displayMode: "textarea" } }),
    /** Which toggle the visitor used, so the reply goes out in that language. */
    language: (0, import_fields10.select)({
      type: "string",
